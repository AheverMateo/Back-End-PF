...
const { Review , Movie , Shops , User, Gender, FavoriteMovie } = sequelize.models;

Movie.belongsToMany(Shops, {through: "moviesShops"});
Shops.belongsToMany(Movie, {through: "moviesShops"});

User.hasMany(Shops, {foreignKey: "userShops"});
